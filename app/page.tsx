  ...
  return (
    <div className="py-12 md:py-16 px-4 md:px-8">
      ...
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white">{t('title')}</h2>
      ...
      <div className="mt-16 text-center">
        <div className="max-w-2xl mx-auto">
          <h3 className="text-2xl font-semibold text-white mb-4">{t('mediaResources.title')}</h3>
          <p className="text-gray-400 mb-6">
            {t('mediaResources.description')}
          </p>
          <Link href="/press-kit">
            <Button variant="outline" size="lg">
              {t('mediaResources.downloadButton')}
            </Button>
          </Link>
        </div>
      </div>
